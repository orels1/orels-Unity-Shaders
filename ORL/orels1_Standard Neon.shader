...
Shader "orels1/Standard Neon"
{
	Properties
	{
		...
		[Enum(X, 0, Y, 1, Z, 2, Negative X, 3, Negative Y, 4, Negative Z, 5)][_NeonTubeCapEnabled] _NeonTubeCapDirection("Tube Cap Direction [_NeonTubeCapEnabled]", Int) =  5
		[_NeonTubeCapEnabled] _NeonTubeCapOffset("Tube Cap Offset [_NeonTubeCapEnabled]", Float) =  0
		[_NeonTubeCapEnabled] _NeonTubeCapColor("Tube Cap Color [_NeonTubeCapEnabled]", Color) =  (0.3, 0.3, 0.3, 1)
		[_NeonTubeCapEnabled] _NeonTubeCapSmoothness("Tube Cap Smoothness [_NeonTubeCapEnabled]", Range(0,1)) =  0.5
